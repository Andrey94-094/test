...
/* harmony default export */ __webpack_exports__["default"] = (calculatorData);
...
/* harmony import */ var _assets_js_data__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../assets/js/data */ "./assets/js/data.js");
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  [].forEach.call(document.querySelectorAll("form.has-calculator"), function (form) {
    form.addEventListener('change', function () {
      ...
      try {
        sum += _assets_js_data__WEBPACK_IMPORTED_MODULE_3__["default"].products[product.value][length.value][interval.value];
        ...
        var tick = function tick(now) {
          ...
          var value = numberFrom + (numberTo - numberFrom) * easing; // outOld.textContent = value.toFixed();

          if (progress < 1) {
            requestAnimationFrame(tick);
          } else {
            out.dataset.from = numberTo.toFixed();
            outOld.textContent = value.Number(numberTo * 1.27).toFixed();
          }
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "295816a0176776977de3"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=bundle.a33427a463b5d5b32846.hot-update.js.map